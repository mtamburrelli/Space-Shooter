...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, center):
        ...
        self.frame_rate = 50  # Explosion velocity
...
def show_go_screen():
    ...
    draw_text(screen, "Arrows To Move \n Spacebar To Shoot", 27, WIDTH // 2, HEIGHT // 2)
    draw_text(screen, "PRESS THE 'UP' KEY", 20, WIDTH // 2, HEIGHT * 3 / 4)
    pygame.display.flip()
    waiting = True
    while waiting:
        clock.tick(60)
...
meteor_images = []
meteor_list = {"shooter-pygame-master/assets/meteorGrey_big1.png", "shooter-pygame-master/assets/meteorGrey_big2.png",
               "shooter-pygame-master/assets/meteorGrey_big3.png",
               "shooter-pygame-master/assets/meteorGrey_big4.png",
               "shooter-pygame-master/assets/meteorGrey_med1.png", "shooter-pygame-master/assets/meteorGrey_med2.png",
               "shooter-pygame-master/assets/meteorGrey_small1.png",
               "shooter-pygame-master/assets/meteorGrey_small2.png",
               "shooter-pygame-master/assets/meteorGrey_tiny1.png", "shooter-pygame-master/assets/meteorGrey_tiny2.png"}
...
pygame.mixer.music.load("shooter-pygame-master/assets/music.ogg")
